package skns.com.mobile.Common.GPS;
...
import skns.com.mobile.Activity.MainActivity;
...
public class GPSManager extends Service implements LocationListener {
    ...
    public void onProviderDisabled(String provider) {
        ...
        mHandler.sendEmptyMessage(BaseActivity.RENEW_GPS);
    ...
    private void sendString(String str){
        ...
        msg.what = BaseActivity.SEND_PRINT;
